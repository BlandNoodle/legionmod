...
economy = {
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.30, -- % of how much we pay to the pops and capitalists, from the leftovers.
...
pops = {
	...
	SLAVE_GROWTH_DIVISOR = 0.8, -- Slaves have N times lower growth
