...
country = {
	...
	CONSERVATIVE_INCREASE_AFTER_REFORM = 0.20, -- how many more conservatives in a upper house.
	...
	CAMPAIGN_DURATION = 9,	-- a campaign lasts these amount of months
	...
	MOBILIZATION_SPEED_BASE = 0.09, -- Base speed for raising troops
	MOBILIZATION_SPEED_RAILS_MULT = 4.2, -- Speed modifier for raising troops. It's max value for max railways level in state.
...
economy = {
	...
	MAX_FACTORY_MONEY_SAVE = 6000,	-- how much money is stored maximum in a factory.
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.1,	-- how fast pops are Hired when there is a high demand
